...
\begin{frame}{Known/unknown fixed order \DRbarp\ loop corrections}
  Loop corrections in the determination of the running MSSM
    ...
    \begin{align*}
      ...
      + \cdots\Big]
    \end{align*}
    \mycite{0105096, 0112177, 0212132, 0206101, 0305127, 1005.5709, \underline{1708.05720}, \textcolor{red}{\underline{1807.XXXX}}}
\end{frame}
...
\begin{frame}{Known/unknown loop corrections in the EFT calculation}
  ...
  \end{align*}
  \mycite{1407.4081, 1504.05200, 1703.08166, \textcolor{red}{\underline{1807.XXXX}}}\\[0.5em]
...
\begin{frame}{Summary FlexibleEFTHiggs approach}
  ...
  \begin{itemize}
  \item large logarithms $\propto\ln(M_S/m_t)$ are resummed
  \item suppressed 1-loop terms $O(v^2/\MS^2)$ are incorporated in $\lambda$
  ...
  \emph{Disadvantage:}
  \begin{itemize}
  \item restricted to the SM as EFT
  \item tricky to extend to 2-loop accuracy (work in progress)
  \item 2-loop suppressed terms of the form $\frac{1}{(4\pi)^4}\frac{v^2}{\MS^2}\times\log(\MS/m_t)$ not resummed
  \end{itemize}
\end{frame}
