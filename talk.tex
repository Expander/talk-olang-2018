...
\begin{frame}{Current status in the MSSM}
  \begin{center}
%    \includegraphics[width=0.49\textwidth]{{{plots/uncertainties/Mh_MS_TB-5_Xt--2}}}\hfill
%    \includegraphics[width=0.49\textwidth]{{{plots/uncertainties/Mh_Xt_TB-5_MS-5000}}}\hfill
