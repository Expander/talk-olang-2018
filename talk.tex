...
\begin{frame}{Uncertainty estimation of FlexibleEFTHiggs 2L}
  \begin{itemize}
  \item use $y_t^{\text{MSSM},(1)}$ vs.\ $y_t^{\text{MSSM},(2)}$
  \item vary $Q_\text{match}$ within $[M_S/2, 2 M_S]$
  \item vary $Q_\text{pole}$ within $[M_t/2, 2 M_t]$
  \end{itemize}
\end{frame}

\begin{frame}{Uncertainty estimation of FlexibleEFTHiggs 1L}
  \begin{figure}
    \centering
...
\begin{frame}{Uncertainty estimation of FlexibleEFTHiggs 2L}
  ...
  \end{figure}
  $\tan\beta = 5$, $M_S = 2\eh{TeV}$, $X_{t,b,\tau} = 0$
\end{frame}
