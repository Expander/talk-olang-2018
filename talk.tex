...
\begin{frame}{Effect of the 3-loop corrections to $M_h$}
  \begin{center}
    \includegraphics[width=0.49\textwidth]{plots/SOFTSUSY/Mh_2L_vs_3L_MS_TB-20_Xt--sqrt6}
  \end{center}
  \mycite{1708.05720}
\end{frame}
...
\begin{frame}{Summary FlexibleEFTHiggs approach}
  ...
  \item 2-loop suppressed terms of the form
    $\frac{1}{(4\pi)^4}\frac{v^2}{\MS^2}\times\log(\MS/M_t)$ are not
    resummed
  \end{itemize}
\end{frame}
