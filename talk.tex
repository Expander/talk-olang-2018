...
\title{Update: Higgs mass prediction in BSM models with FlexibleSUSY
  using an EFT calculation with $M_h$ matching \\---\\ Higgs mass
  prediction in the THDH from high-scale SUSY}
...
\begin{frame}[noframenumbering]{MRSSM}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{{plots/scale_MRSSM_yt_variants}}
  \end{figure}
\end{frame}
