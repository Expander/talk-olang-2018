...
\subject{FlexibleSUSY,MSSM,THDM,Higgs,FlexibleEFTHiggs}
\keywords{FlexibleSUSY,MSSM,THDM,Higgs,FlexibleEFTHiggs}
...
\begin{frame}{EFT approach with $M_h$ matching}
  ...
  with
  \begin{align*}
    (M_h^{\SM})^2 &= \lambda v^2 - \Sigma^{\SM}_h(M_h^2) + \frac{t_h^\SM}{v}
  \end{align*}
  $\Rightarrow$
  \begin{align*}
