...
\title{Automated Higgs mass prediction in BSM models with
  FlexibleSUSY using a mixed full / EFT approach}
...
\begin{frame}{Full model approach (\DRbar\ codes)}
  \begin{center}
...
\begin{frame}{Comparison full vs.\ EFT approach}
  \begin{figure}
    \centering
...
\begin{frame}{Combining EFT and full approach}
  \begin{center}
    \includegraphics[width=0.45\textwidth]{images/mssm-sm-tower-eft}\\[1em]
  \end{center}
  \emph{Idea:} Calculate $M_h$ in the SM as a function of the \MSbar\ parameters:\\[1em]
...
\begin{frame}{Combining EFT and full approach: matching $M_h$}
  \begin{align*}
...
\begin{frame}{Comparison full vs.\ EFT vs.\ mixed approach}
  \begin{figure}
    \centering
...
\begin{frame}{Summary}
  \emph{Summary:}
  \begin{itemize}
  \item full approach suffers from large logs
...
\begin{frame}[noframenumbering]{Comparison full vs.\ EFT vs.\ mixed approach}
  \begin{figure}
    \centering
