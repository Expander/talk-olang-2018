...
\title{NMSSM spectrum calculation with FlexibleSUSY}

\author[Alexander Voigt]{Peter Athron, Jae-hyeon Park,\\ Dominik Stöckinger, \underline{Alexander Voigt}}

\date{08.06.2015}

\institute[CERN]{LHCXSWG BSM3 meeting -- NMSSM tools\\
CERN}
\subject{FlexibleSUSY,NMSSM}
\keywords{FlexibleSUSY,NMSSM}
...
\section{Implemented NMSSM variants}
