...
\begin{frame}{Comparison full model vs.\ EFT approach}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{plots/scale_MSSM}
  \end{figure}
...
\begin{frame}{Comparison full model vs.\ EFT approach}
  \begin{center}
    Q1: Why is FlexibleSUSY/MSSM so close to the EFT approaches and
    SPheno so far off?
  \end{center}
\end{frame}

\begin{frame}{Calculation of $y_t^{\text{MSSM}}$}
  A1: Different treatment of 2-loop corrections to $y_t^{\text{MSSM}}$:
  \\[1em]
  \emph{FlexibleSUSY:}
  \begin{align*}
    m_t &=
...
\begin{frame}{Uncertainty estimation in the full model approach}
  \begin{figure}
    \centering
    % \includegraphics[width=\textwidth]{plots/scale_MSSM_uncertainty_MSSM}
...
\begin{frame}{Uncertainty estimation in the automatic EFT approach}
  \begin{figure}
    \centering
    % \includegraphics[width=\textwidth]{plots/scale_MSSM_uncertainty_all}
    \includegraphics[width=\textwidth]{plots/scale_MSSM_uncertainty_tower}
  \end{figure}
  $\tan\beta = 5$, $X_{t,b,\tau} = 0$
\end{frame}
...
\begin{frame}{Uncertainty estimation in the automatic EFT approach}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{plots/xt_MSSM_MS-2000}
  \end{figure}
