...
\begin{frame}{Summary of automatic EFT approach}
  ...
  \item includes all 1L terms $O(p^n/M_S^n, v^n/M_S^n)$ from SUSY particles
  \end{itemize}
  \emph{Disadvantage:}
  \begin{itemize}
...
\begin{frame}{Uncertainty estimation in the full model approach}
  ...
  \end{align*}
  In the MSSM \bigcite{hep-ph/0210258}: $C_3 = -184/9 \approx 20$
\end{frame}
...
\begin{frame}{Comparison of full model and automatic EFT approach}
  \begin{figure}
    \centering
