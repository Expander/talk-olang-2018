...
\begin{frame}{Improvement 1: FlexibleEFTHiggs-2L}
  ...
  \item[\ok] non-log terms correct at 2L
...
\begin{frame}{Improvement 2: FlexibleEFTHiggs-1L\fsstar}
  ...
  \emph{Disadvantage:}
  \begin{itemize}
  \item[\meh] more difficult to add 2L corrections
...
\begin{frame}{Summary}
  ...
  \item[\ok] easily automatizable
  \item[\ok] correctly resums LL
  \item[\ok] all non-log terms correct at 1L, including all terms $O(p^n/M_S^n, v^n/M_S^n)$
