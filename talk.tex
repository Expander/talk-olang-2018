...
\section{Higgs sector in the MSSM}
...
\begin{frame}{EFT avoids large logarithmic corrections}
  \begin{enumerate}
  \item Match all renormalized $n$-point functions at $p^2 = v^2 = 0$, $Q =
  ...
  \item Calculate $M_h$ in the SM at $Q = M_t$:
    \begin{align*}
      (M_h^\SM)^2
       &= \lambda v^2 + (\Delta m_h^2)^{1L} + (\Delta m_h^2)^{2L} + (\Delta m_h^2)^{3L} + \cdots \\
       &= \lambda v^2 + \frac{12 m_t^2 y_t^2}{(4\pi)^2 v^2} \ln\frac{Q^2}{m_t^2} + \cdots
    \end{align*}
    $\Rightarrow$ \textcolor{darkgreen}{no large logs}
  \end{enumerate}
\end{frame}
...
\begin{frame}{Comparison of fixed-order and EFT approaches}
  \begin{center}
    \includegraphics[width=0.49\textwidth]{{{plots/uncertainties/Mh_MS_TB-5_Xt-0_FO_EFT}}}
    \hfill
    \includegraphics[width=0.49\textwidth]{{{plots/uncertainties/DMh_MS_TB-5_Xt-1}}}
  \end{center}
\end{frame}
...
\begin{frame}[noframenumbering]{Effect of higher-dimensional operators}
  \begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{plots/6dim-Operators/delta-mh-vs-MS-tb-20-M3-MS}
    \hfill
    \includegraphics[width=0.49\textwidth]{plots/6dim-Operators/delta-mh-vs-MS-tb-20-M3-2-MS}
  \end{figure}
  $\tan\beta = 20$, $X_t = \sqrt{6}\,\MS$
  \\\mycite{1703.08166}
\end{frame}
...
\begin{frame}[noframenumbering]{Effect of higher-dimensional operators}
  \begin{figure}
    \centering
    \includegraphics[width=0.49\textwidth]{plots/6dim-Operators/delta-mh-vs-Xt-tb-20-M3-2000-MS-1-TeV}
    \hfill
    \includegraphics[width=0.49\textwidth]{plots/6dim-Operators/delta-mh-vs-Xt-tb-20-M3-MS-MS-1-TeV.pdf}
  \end{figure}
  $\MS = 1\eh{TeV}, \tan\beta = 20$
  \\\mycite{1703.08166}
\end{frame}
