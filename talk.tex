...
\begin{frame}{EFT approach: matching all $\Gamma_{\phi_1,\ldots,\phi_n}(Q = M_S)$}
  ...
  \begin{align*}
    (M_h^\SM)^2 &= \lambda v^2 - \Sigma^\SM_h((M_h^\SM)^2,M_t) + \frac{t_h^\SM}{v}
  \end{align*}
...
\begin{frame}{Uncertainty estimation in the full model approach}
  ...
  \begin{align*}
    ...
    \right]
  \end{align*}
  Parametrize difference by adding
  \begin{align*}
...
\begin{frame}{Uncertainty estimation in the automatic EFT model approach}
