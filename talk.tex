...
\begin{frame}{Uncertainty of the fixed order \DRbarp\ calculation}
  ...
  \item Missing higher order corrections in the determination of the
    running MSSM parameters $y_f^\MSSM$, $g_i^\MSSM$:
    \begin{align*}
...
\begin{frame}{Uncertainty of the EFT calculation}
  Three main sources:\\[1em]  
  \emph{1. SM uncertainty:}
  \begin{itemize}
  \item Missing higher order corrections in the
    determination of the running SM parameters $y_f^\SM$, $g_i^\SM$:
    \begin{align*}
...
\begin{frame}{Uncertainty of the EFT calculation}
  \emph{2. SUSY uncertainty:}
  Missing higher order corrections in the determination of
  $\lambda(\MS)$:
  \begin{align*}
  ...
  \end{align*}
  \emph{3. EFT uncertainty:} Missing terms of $O(v^2/\MS^2)$
\end{frame}
