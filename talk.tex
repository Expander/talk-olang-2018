...
\begin{frame}{Available full MSSM models and EFTs}
  \resizebox{\textwidth}{!}{%
    \begin{tabular}{llll}
...
\begin{frame}{Contents of the approaches}
  \tableofcontents[currentsection]  
\end{frame}
...
\begin{frame}{Equivalence EFT and automatic EFT approach $O(y_t^4)$}
  \begin{align*}
    M_h^{\SM} &\overset{!}{=} M_h^\text{MSSM} \quad \text{at} \quad Q = M_S, 1L
  \end{align*}
  where
...
\begin{frame}[noframenumbering]
  \begin{center}
    \Large Calculation of SM parameters
  \end{center}
\end{frame}
...
\begin{frame}[noframenumbering]
  \begin{center}
    \Large Calculation of MSSM parameters
  \end{center}
\end{frame}
